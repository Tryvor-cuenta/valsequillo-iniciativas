...
import { ArrowRight, Briefcase, BookOpen, Building2, TrendingUp, Heart } from "lucide-react";
...
const QUICK_ACCESS = [
  ...
  { href: "/trabaja-con-nosotros", icon: BookOpen, label: "Trabaja con nosotros", desc: "Envía tu candidatura" },
    ...
    <>
      ...
      <main>
        ...
        <section className="relative min-h-[480px] flex items-center">
          {/* Imagen de fondo — cuando esté disponible hero.jpg se mostrará automáticamente */}
          <div
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-white text-center">
            ...
            <LinkButton href="/servicios" size="lg" className="bg-white text-[#00695C] hover:bg-gray-100 font-semibold">
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-2xl font-bold text-gray-900 text-center mb-10">Áreas de actuación</h2>
        ...
        <section className="py-16 px-4">
          <div className="max-w-6xl mx-auto">
            <div className="flex items-center justify-between mb-10">
              ...
              <Link href="/actualidad" className="text-sm text-[#00695C] hover:underline flex items-center gap-1">
                Ver todas <ArrowRight className="h-4 w-4" />
              </Link>
            </div>
            {news.length === 0 ? (
              <p className="text-gray-500 text-center py-12">Próximamente publicaremos noticias y novedades.</p>
            ) : (
                  ...
                  <Link key={item.id} href={`/actualidad/${item.slug}`} className="group">
                    <Card className="h-full hover:shadow-md transition-shadow overflow-hidden">
                      ...
                      <CardContent className="p-5">
                        {item.etiqueta && <Badge variant="secondary" className="mb-3 text-xs">{item.etiqueta}</Badge>}
                        <p className="text-xs text-gray-400 mb-2">
                          {new Date(item.fecha_publicacion).toLocaleDateString("es-ES", { day: "numeric", month: "long", year: "numeric" })}
                        </p>
                        <h3 className="font-semibold text-gray-900 leading-snug group-hover:text-[#00695C] transition-colors">{item.titulo}</h3>
        ...
        <section className="bg-gray-50 border-t border-gray-200 py-16 px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">¿Tienes un proyecto o necesitas orientación?</h2>
            <p className="text-gray-500 mb-6">Nuestro equipo está aquí para ayudarte. Contacta con nosotros y te asesoraremos sin compromiso.</p>
